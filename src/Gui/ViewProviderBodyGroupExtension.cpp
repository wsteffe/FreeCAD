...
EXTENSION_PROPERTY_SOURCE(Gui::ViewProviderBodyGroupExtension, Gui::ViewProviderGroupExtension)

ViewProviderBodyGroupExtension::ViewProviderBodyGroupExtension()
{
    initExtensionType(ViewProviderBodyGroupExtension::getExtensionClassTypeId());
...
std::vector<App::DocumentObject*> ViewProviderBodyGroupExtension::extensionClaimChildren3D() const {
    ...
    auto* ext = obj ? obj->getExtensionByType<App::GroupExtension>() : nullptr;
    if (ext) {
...
std::vector<App::DocumentObject*> ViewProviderBodyGroupExtension::extensionClaimChildren() const {
    ...
    for (auto obj: model) {
        ...
        if (!obj || obj->hasExtension(App::GroupExtension::getExtensionClassTypeId())) { continue; }
...
void ViewProviderBodyGroupExtension::extensionFinishRestoring()
{
...
void ViewProviderBodyGroupExtension::extensionAttach(App::DocumentObject* pcObject)
{
    ViewProviderGroupExtension::extensionAttach(pcObject);
    getExtendedViewProvider()->addDisplayMaskMode(pcGroupChildren, "Group");
}

void ViewProviderBodyGroupExtension::extensionSetDisplayMode(const char* ModeName)
{
...
std::vector<std::string> ViewProviderBodyGroupExtension::extensionGetDisplayModes() const
{
...
void ViewProviderBodyGroupExtension::extensionUpdateData(const App::Property* prop)
{
    auto obj = getExtendedViewProvider()->getObject();
    auto grp = obj ? obj->getExtensionByType<App::GroupExtension>() : nullptr;
    ViewProviderGroupExtension::extensionUpdateData ( prop );
}

namespace Gui {
EXTENSION_PROPERTY_SOURCE_TEMPLATE(Gui::ViewProviderBodyGroupExtensionPython, Gui::ViewProviderBodyGroupExtension)

// explicit template instantiation
template class GuiExport ViewProviderExtensionPythonT<ViewProviderBodyGroupExtension>;
}
