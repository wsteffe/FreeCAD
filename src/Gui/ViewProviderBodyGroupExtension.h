...
#ifndef GUI_VIEWPROVIDERBODYGROUPEXTENSION_H
#define GUI_VIEWPROVIDERBODYGROUPEXTENSION_H
...
class GuiExport ViewProviderBodyGroupExtension : public ViewProviderGroupExtension
{
    EXTENSION_PROPERTY_HEADER_WITH_OVERRIDE(Gui::ViewProviderBodyGroupExtension);

public:
    /// Constructor
    ViewProviderBodyGroupExtension();
    ~ViewProviderBodyGroupExtension() override;
...
using ViewProviderBodyGroupExtensionPython = ViewProviderExtensionPythonT<Gui::ViewProviderBodyGroupExtension>;

} //namespace Gui

#endif // GUI_VIEWPROVIDERBODYGROUPEXTENSION_H
