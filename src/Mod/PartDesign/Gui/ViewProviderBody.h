...
#include <Gui/ViewProviderBodyGroupExtension.h>
 ...
 * \author jriegel
 */
class PartDesignGuiExport ViewProviderBody : public PartGui::ViewProviderPart, public Gui::ViewProviderBodyGroupExtension
{
