...
ViewProviderPartExt::ViewProviderPartExt() 
{
    ...
    unsigned long vcol = Gui::ViewParams::DefaultShapeVertexColor(); 
    float vr,vg,vb;
    vr = ((vcol >> 24) & 0xff) / 255.0; vg = ((vcol >> 16) & 0xff) / 255.0; vb = ((vcol >> 8) & 0xff) / 255.0;
    int lwidth = Gui::ViewParams::DefaultShapeLineWidth();
    int psize = Gui::ViewParams::DefaultShapePointSize();
